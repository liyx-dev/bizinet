...
document.addEventListener('touchend', e => {
    ...
    if (touchEndX < touchStartX - swipeThreshold && currentIndex < tabsList.length - 1) {
        switchTab(tabsList[currentIndex + 1]); // Swipe Left -> Next
    } else if (touchEndX > touchStartX + swipeThreshold && currentIndex > 0) {
        switchTab(tabsList[currentIndex - 1]); // Swipe Right -> Prev
    }
}, {passive: true});
